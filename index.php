...
<form>
  <div class="form-group">
    ...
    <input type="name" class="form-control" placeholder="Usuario"  autocomplete="off " required>
  ...
  <div class="text-right">
    <a  href="cadastroUsuario.php" role="button" class="btn  btn-primary " style="color: white">Cadastrar</a>
